...
const TRANSLATIONS = {
  en: {
    ...
    scheduleFamiliesPart2: ' and family and ',
    scheduleFamiliesBold2: 'Smt. Fakkiramma Hanchinamani',
    scheduleFamiliesPart3: ' and family await you with the warmth of a thousand lit lamps.',
    groomName: 'Aman Roy',
  ...
  bh: {
    ...
    introInvited: 'दू जिनगी एक राहता धरत बा, रउआ से निहोरा बा एह पवित्तर बेरा के साखी बनी',
    ...
    ganeshMantra: 'श्री गणेशाय नमः',
    scheduleLine1: 'दू घर के छाँव एक अँगना में मिल रहल बा। एह घरी के रउआ अपना आँखि से देखीं, बस इहे बिनती बा।',
    scheduleLineBottom: 'असीस के कवनो मोल नइखे। ऊ त दिहल जाला, लिहल जाला। रउआ आईं, बस एतने काफी बा।',
    scheduleFamiliesPart1: '',
    scheduleFamiliesBold1: 'एस.एन/एम.एन. रॉय',
    scheduleFamiliesPart2: ' परिवार आउर ',
    scheduleFamiliesBold2: 'श्रीमती फक्किरम्मा हंचिनामनी',
    scheduleFamiliesPart3: ' परिवार रउरा राह में मन के फूल बिछवले बाड़े, बस पधारीं।',
    groomName: 'अमन रॉय',
    ...
    dressNote: '<p>हर रसम के आपन रंग होला। रउआ ओही रंग में आईं, कवनो बंधन नइखे, बस हमनी के रंगवा में रंगाये के कोसिस करीं।</p><ul><li><strong>सगाई आ संगीत:</strong> भारतीय-पाश्चात्य शैली (इंडो-वेस्टर्न)</li><li><strong>बियाह विधि:</strong> पारंपरिक भारतीय परिधान (एथनिक)</li><li><strong>स्वागत:</strong> औपचारिक पोशाक (फॉर्मल)</li></ul>',
