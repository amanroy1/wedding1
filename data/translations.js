...
const TRANSLATIONS = {
  ...
  bh: {
    ...
    dressNote: '<p>हर रसम के आपन रंग होला। रउआ ओही रंग में आईं, कवनो बंधन नइखे, बस हमनी के रंगवा में रंगावे के कोसिस करीं।</p><ul><li><strong>सगाई आ संगीत:</strong> भारतीय-पाश्चात्य शैली (इंडो-वेस्टर्न)</li><li><strong>बियाह विधि:</strong> पारंपरिक भारतीय परिधान (एथनिक)</li><li><strong>स्वागत:</strong> औपचारिक पोशाक (फॉर्मल)</li></ul>',
