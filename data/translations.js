...
const TRANSLATIONS = {
  en: {
    ...
    scheduleFamiliesPart1: '',
    scheduleFamiliesBold1: 'S.N/M.N. Roy',
    scheduleFamiliesPart2: ' family and ',
    scheduleFamiliesBold2: 'Smt. Fakkiramma Hanchinamani',
    scheduleFamiliesPart3: ' family await you with the warmth of a thousand lit lamps.',
    groomName: 'Aman Roy',
  ...
  hi: {
    ...
    scheduleFamiliesPart1: '',
    scheduleFamiliesBold1: 'एस.एन/एम.एन. रॉय',
    scheduleFamiliesPart2: ' परिवार और ',
    scheduleFamiliesBold2: 'श्रीमती फक्किरम्मा हंचिनामनी',
    scheduleFamiliesPart3: ' परिवार आपकी राह में फूल बिछाए खड़े हैं, बस आप आ जाइए।',
    groomName: 'अमन रॉय',
    ...
    dressNote: '<p>कपड़े तो बस एक बाहरी बात है, पर हर रस्म का एक अपना मिज़ाज होता है। हम चाहते हैं कि आप उसमें घुल जाएं।</p><ul><li><strong>सगाई और संगीत:</strong> भारतीय-पाश्चात्य शैली (इंडो-वेस्टर्न)</li><li><strong>विवाह विधि:</strong> पारंपरिक भारतीय परिधान (एथनिक)</li><li><strong>स्वागत समारोह:</strong> औपचारिक पोशाक (फॉर्मल)</li></ul>',
  ...
  kn: {
    ...
    scheduleFamiliesPart1: '',
    scheduleFamiliesBold1: 'ಎಸ್.ಎನ್/ಎಂ.ಎನ್. ರಾಯ್',
    scheduleFamiliesPart2: ' ಕುಟುಂಬ ಮತ್ತು ',
    scheduleFamiliesBold2: 'ಶ್ರೀಮತಿ ಫಕ್ಕಿರಮ್ಮ ಹಂಚಿನಮನಿ',
    scheduleFamiliesPart3: ' ಕುಟುಂಬ ನಿಮ್ಮ ದಾರಿಯಲ್ಲಿ ಮನದ ಹೂಗಳನ್ನು ಚೆಲ್ಲಿ ಕಾಯುತ್ತಿದೆ।',
    groomName: 'ಅಮನ್ ರಾಯ್',
    groomParentLine: 'ಶ್ರೀ ಮನೋಜ್ ಕುಮಾರ್ ರಾಯ್ & ಶ್ರೀಮತಿ ಸುನೀತಾ ರಾಯ್ ಅವರ ಸುಪುತ್ರ',
    brideName: 'ಸೋನಾಲಿ ಹಂಚಿನಮನಿ',
    brideParentLine: 'ಶ್ರೀ ಚಂದ್ರಶೇಖರ್ ಹಂಚಿನಮನಿ & ಶ್ರೀಮತಿ ನಾಗಲಕ್ಷ್ಮಿ ಹಂಚಿನಮನಿ ಅವರ ಸುಪುತ್ರಿ',
  ...
  bh: {
    ...
    sealAria: 'नेवता खोलीऽ',

    ovBlessing: 'शुभ विवाह',
    ovNames: 'अमन संगे सोनाली',
    ovDate: '25 · जून · 2026',
    ovLocation: 'बंगलौर, भारत',

    ganeshMantra: 'श्री गणेशाय नमः',
    scheduleLine1: 'दू घर के छाँव एक अँगना में मिल रहल बा। एह घरी के रउआ अपना आँखि से देखीऽ, बस इहे बिनती बा।',
    scheduleLineBottom: 'असीस के कवनो मोल नइखे। ऊ त दिहल जाला, लिहल जाला। रउआ आईऽ, बस एतने काफी बा।',
    scheduleFamiliesPart1: '',
    scheduleFamiliesBold1: 'एस.एन/एम.एन. रॉय',
    scheduleFamiliesPart2: ' परिवार आउर ',
    scheduleFamiliesBold2: 'श्रीमती फक्किरम्मा हंचिनामनी',
    scheduleFamiliesPart3: ' परिवार रउरा राह में मन के फूल बिछवले बाड़े, बस पधारीऽ।',
    groomName: 'अमन रॉय',
    groomParentLine: 'मनोज कुमार रॉय आ सुनीता रॉय के लइका',
    brideName: 'सोनाली हंचिनामनी',
    brideParentLine: 'चंद्रशेखर हंचिनामनी आ नागलक्ष्मी हंचिनामनी के लइकी',

    seeInMap: 'नकसा में देखीऽ',
    date: 'तारीख',
    time: 'समय',
    venueLabel: 'स्थल',

    dressNote: '<p>हर रसम के आपन रंग होला। रउआ ओही रंग में आईऽ, कवनो बंधन नइखे, बस हमनी के रंगवा में रंगाये के कोसिस करीऽ।</p><ul><li><strong>सगाई आ संगीत:</strong> भारतीय-पाश्चात्य शैली (इंडो-वेस्टर्न)</li><li><strong>बियाह विधि:</strong> पारंपरिक भारतीय परिधान (एथनिक)</li><li><strong>स्वागत:</strong> औपचारिक पोशाक (फॉर्मल)</li></ul>',

    forLadke: 'लइका वाला खातिर',
    forLadki: 'लइकी वाला खातिर',
    contactGroomLine: 'अंकित आर. से बतियाईऽ ',
    contactBrideLine: 'चंद्रशेखर एच. से बतियाईऽ ',
    call: 'कॉल',
    whatsApp: 'व्हाट्सऐप',

    tabSchedule: 'कार्यक्रम',
    tabEvents: 'कार्यक्रम',
    tabAttire: 'जोड़ा-जामा',
    tabContact: 'संपर्क',
    ...
    ariaSchedule: 'कार्यक्रम',
    ariaContact: 'संपर्क',
    ariaPauseMusic: 'पाछे के संगीत रोकीऽ',
    ariaPlayMusic: 'पाछे के संगीत चलावीऽ',
